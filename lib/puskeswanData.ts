...
export const initialPuskeswanProfiles: PuskeswanProfil[] = [
  {
    ...
    kode: 'PREMBUN',
    wilayah_binaan: 'Kecamatan Padureso, Kecamatan Prembun, Kecamatan Kutowinangun',
  ...
  },
  {
    ...
    kode: 'MIRIT',
    wilayah_binaan: 'Kecamatan Mirit, Kecamatan Ambal, Kecamatan Bonorowo',
  ...
  },
  {
    ...
    kode: 'KEBUMEN',
    wilayah_binaan: 'Kecamatan Kebumen, Kecamatan Poncowarno, Kecamatan Buluspesantren',
  ...
  },
  {
    ...
    kode: 'ALIAN',
    wilayah_binaan: 'Kecamatan Alian, Kecamatan Sadang, Kecamatan Karangsambung',
  ...
  },
  {
    ...
    kode: 'KLIRONG',
    wilayah_binaan: 'Kecamatan Klirong, Kecamatan Petanahan, Kecamatan Adimulyo',
  ...
  },
  {
    ...
    kode: 'KARANGANYAR',
    wilayah_binaan: 'Kecamatan Pejagoan, Kecamatan Karanganyar, Kecamatan Karanggayam, Kecamatan Sruweng',
